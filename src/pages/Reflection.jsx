...
export default function Reflection() {
  return (
    <div className="min-h-screen bg-gradient-to-r from-orange-500 via-pink-500 to-red-600 dark:from-orange-600 dark:via-pink-600 dark:to-red-700 text-white flex flex-col items-center justify-center p-10 text-center space-y-6">
